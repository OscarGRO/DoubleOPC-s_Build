...
// Funcion para elegir los ocho componentes del PC
...
void pcBuild() {
    ...
    int menuOpc;
    do {
        cout << "---------- Bienvenido a DoubleOPC's ----------" << endl;
        cout << "Escoga una de las siguientes opciones entre el 1 y el 4: " << endl;
        ...
        case 4:
            cout << "**********************************************************************" << endl;
            cout << "Gracias por visitar DoubleOPC's. Hasta luego!" << endl;
            Sleep(4000);
            system("cls");
            break;
